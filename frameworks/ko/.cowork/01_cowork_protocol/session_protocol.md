...
- [ ] `project_state.md`에서 프로젝트 유형, 팀 구성 모드, 대화 언어, 작업 문서 언어, 공식 산출물 문서 언어, 시각화 모드 확인
...
- 필요 시 대화 언어, 작업 문서 언어, 공식 산출물 문서 언어, 시각화 모드는 무엇인가?
...
- [ ] **최초 세션 최소 입력 확인** — 최초 세션이거나 아직 온보딩 미완료 상태라면 아래 최소 입력이 채워졌는지 확인하고, 누락 시 종료 전에 한 번 더 재질문한다
  ...
  - 필요 시 대화 언어 / 작업 문서 언어 / 공식 산출물 문서 언어 / 시각화 모드
...
2. `project_state.md`에서 프로젝트 유형(신규/기존), 팀 구성 모드, 대화 언어, 작업 문서 언어, 공식 산출물 문서 언어, 시각화 모드 확인
