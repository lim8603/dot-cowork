...
- Gate 4/5는 대상 revision·환경·필수 시나리오가 일치하는 근거로 판단한다. `verification_evidence.md`의 유효 범위·미검증 관리 규칙을 따른다. Task Done·프로젝트 Green·과거 버전의 Pass를 현재 릴리즈 승인으로 대체하지 않는다.
