...
This is the project entrypoint for OpenAI Codex and Cursor. Prioritize the user's current request and read only the `.cowork/` documents needed for the task. For other tool entrypoints and usage, see `.cowork/README.md`.
